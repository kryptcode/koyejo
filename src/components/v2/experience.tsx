...
const Experience = () => {
  return (
    <div className=" min-h-screen pb-24 w-[90%] mx-auto font-grotesk ">
      ...
      <div>
        <div
          className={`border-neutral-500 my-10 flex flex-col md:flex-row gap-10 rounded-xl border-[2.5px]  border-l-[5px] border-b-[5px] p-3 py-6 transition-all ease-linear duration-300 group`}
        >
        ...
        >
          ...
          <div className="flex-[2.5] ">
            ...
            <div className="text-xl font-medium text-neutral-500">
              ...
              RESTful APIs with Express.js, and consistently delivered
