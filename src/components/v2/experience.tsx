      ...
      <div className="lg:w-[80%] ">
        <ol className="relative border-s border-gray-700 dark:border-gray-700">
          <li className="mb-10 ms-4">
            ...
            <time className="mb-1 font-normal leading-none text-gray-500 dark:text-gray-500">
              March 2021 - February 2022
            </time>
            <h3 className="text-3xl font-semibold text-white dark:text-white">
              Front-End Developer . Freelance
            </h3>
            <h5 className="text-neutral-600 mb-1.5">Full-Time</h5>
            <p className="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
              ...
              and developed custom websites and web applications using React and
              Next.js, implemented responsive designs, integrated RESTful APIs,
              and consistently delivered projects on time and within budget,
              earning positive client feedback.
            </p>
          </li>
          <li className="mb-10 ms-4">
            <div className="absolute w-3 h-3  rounded-full mt-1.5 -start-1.5 border border-gray-900 dark:border-gray-900 bg-gray-700"></div>
            ...
            <h5 className="text-neutral-600 mb-1.5">Contract</h5>
            <p className="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
          ...
          <li className="mb-10 ms-4">
            ...
            <p className="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
              ...
              Laravel to build dynamic applications, integrated RESTful APIs for
              real-time data, and maintained version control with Git and
              GitHub.
            </p>
          </li>
          <li className="mb-10 ms-4">
            ...
            <h5 className="text-neutral-600 mb-1.5">Part-Time</h5>
            <p className="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
              Collaborated with clients to understand project goals, designed
              and developed custom websites and web applications using React,
              Framer, and WordPress, implemented responsive designs, integrated
              RESTful APIs with Express.js and Flask, and consistently delivered
              projects on time and within budget, earning positive client
              feedback.
            </p>
          </li>
        </ol>
