    ...
    <>
      <main className="relative bg-white font-grotesk text-black min-h-[200vh] max-w-[1440px] w-full">
        ...
        <div className="p-5 lg:p-10 pt-16">
                ...
                <div className="mb-4 lg:mb-10" key={index}>
                  <div>
                    <Link
                      ...
                      href={'/archives'}
                      className="mb-1 inline-block cursor-pointer group border-b-2 leading-none border-black hover:border-white translate-x-0 duration-300 ease-linear "
                    >
          ...
          <div className="py-10">
            <Link href="/archives" className=" inline-block cursor-pointer group border-b-2 leading-none border-black hover:border-white translate-x-0 duration-300 ease-linear text-3xl lg:text-5xl font-medium">
              View More
            </Link>
          </div>
        </div>
        ...
        <div className="p-5 lg:p-10 pt-16">
          ...
          <div className="pb-10">
            ...
            <h2 className="text-3xl lg:text-6xl font-extrabold">Front-End Developer . Freelance</h2> 
          </div>
          <div className="pb-10">
            <h6 className="text-xl lg:text-3xl font-bold">March 2022 - October 2022</h6>
            <h2 className="text-3xl lg:text-6xl font-extrabold">Front-End Developer . Zeta Tech</h2> 
          </div>
          <div className="pb-10">
            <h6 className="text-xl lg:text-3xl font-bold">May 2023 - March 2024</h6>
            <h2 className="text-3xl lg:text-6xl font-extrabold">Software Developer . QClose</h2> 
          </div>
          <div className="pb-10">
            <h6 className="text-xl lg:text-3xl font-bold">November 2022 - Present</h6>
            <h2 className="text-3xl lg:text-6xl font-extrabold">Full-Stack Developer . Freelance</h2> 
          </div>
        </div>
        ...
        <div className="p-5 lg:p-10 pb-24">
          ...
          <div className="text-3xl lg:text-6xl font-extrabold">
            Let&apos;s get in touch! You can message me through my <Link href="https://twitter.com/koye_vi" className=" inline-block cursor-pointer group border-b-2 leading-none border-black hover:border-white translate-x-0 duration-300 ease-linear">Twitter</Link> or by sending me an <Link href="mailto:adeyombokehd@gmail.com" className=" inline-block cursor-pointer group border-b-2 leading-none border-black hover:border-white translate-x-0 duration-300 ease-linear">email.</Link>
          </div>
        </div>
